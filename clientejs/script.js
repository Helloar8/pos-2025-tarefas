...
async function loadPokemonsList() {
    try {
        ...
        if (!res.ok) throw new Error("Falha ao buscar a lista de Pokémons");
        ...
        listDiv.innerHTML = "<p class='text-danger'>Falha ao carregar a lista de Pokémons. Tente novamente mais tarde.</p>";
    }
}
...
async function loadPokemonDetails(url) {
    try {
        ...
        if (!res.ok) throw new Error("Falha ao buscar os detalhes do Pokémon");
        const data = await res.json();
        ...
        detailsDiv.innerHTML = "<p class='text-danger'>Falha ao carregar os detalhes do Pokémon. Tente novamente mais tarde.</p>";
    }
}
